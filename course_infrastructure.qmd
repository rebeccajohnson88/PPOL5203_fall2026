...
Here's a notebook to teach you how to use Python in Rstudio. Check out [the intro to quarto notebook](lecture_notes/week-1/intro-to-quarto.qmd). Let's cover some of the installation steps here:
