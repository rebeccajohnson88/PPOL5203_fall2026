...
Look familiar? [https://github.com/rebeccajohnson88/PPOL5203_fall2026](https://github.com/rebeccajohnson88/PPOL5203_fall2026){target="_blank"}
...
Depending on the context, you *may* store data, but 
...
- Instead, read data directly from its source or have download instructions
...
## Troubleshooting issues: error about main not found

Some versions of GitHub default to a branch called `master` as the primary branch rather than a branch called `main`. 

**How do I check what the branch is called on my machine?** Run `git log` and it should show you the name as main or master at the top. As you can see in this screenshot, mine shows `main`

```{r  echo=FALSE, out.width = "40%", fig.align="center"}
knitr::include_graphics("week2_figs/default_branch.png") 
```


**What do I do if mine shows `master` rather than `main`?** Modify the code for the push command to push to `master` rather than `main`, or:
...
## Troubleshooting issues: 403 error when pushing

If you've already tried giving your personal access token (PAT) to GitHub and are getting a 403 error when pushing, you might have not given that token permission to access your repos

To fix:

1. Delete token and
2. Generate a new token and make sure to select these repo options under the scopes 3. Repeat the `git push -u origin main` step and feed it the new PAT

```{r  echo=FALSE, out.width = "40%", fig.align="center"}
knitr::include_graphics("week2_figs/pat_scopes.png") 
```
...
Also linked on our class page: [https://rebeccajohnson88.github.io/PPOL5203_fall2026/weeks/week-02.html](https://rebeccajohnson88.github.io/PPOL5203_fall2026/weeks/week-02.html)

You may need to click through to authorize Classroom 50, which is a tool for managing assignments through GitHub that has replaced the now-defunct GitHub Classroom
...
- Commit and push your changes (git commit and git push)
